...
\begin{abstract}
    ...
    le diverse componenti software di un sistema. All’interno di questo
    ...
    sfide implementative e di compatibilità causate dalla natura complessa di
    Alchemist, e la rigida e semplice struttura di uno schema GraphQL. Infine,
    sono illustrare le future estensioni possibili del sistema costruito,
